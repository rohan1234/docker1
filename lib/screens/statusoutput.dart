...
class StatusOut extends StatefulWidget {
  final String image;
  final String name;

  StatusOut({this.image, this.name});

  @override
  StatusOutState createState() => StatusOutState(image: this.image, name: this.name);
}

class StatusOutState extends State<StatusOut> {
  final String image;
  final String name;

  StatusOutState({this.image, this.name});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Status of  Container")),
      body: Container(
